...
<template>
  <div class="py-5 border-b dark:border-gray-800  font-semibold bg-white/30 dark:bg-gray-800/10 backdrop-filter backdrop-blur-lg border border-white/20 dark:border-gray-800/10">
    <div class="absolute inset-x-0 top-full h-2 bg-gradient-to-b from-sky-600/30 to-transparent"></div>
